...
/**
 * Create a signed SSO token (HMAC-SHA256 JWT).
 * Only the Hub should call this.
 */
export function createSSOToken(payload: Omit<SSOPayload, 'iat' | 'exp'>, secret: string): string {
...
/**
 * Verify a signed SSO token. Returns the payload or null if invalid/expired.
 */
